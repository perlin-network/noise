...
func (*BasicMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_basic_68b6d7df4473c936, []int{0}
}
...
func init() {
	proto.RegisterFile("examples/basic/messages/basic.proto", fileDescriptor_basic_68b6d7df4473c936)
}

var fileDescriptor_basic_68b6d7df4473c936 = []byte{
