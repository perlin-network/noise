...
func (m *ID) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PublicKeyHash) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintProxy(dAtA, i, uint64(len(m.PublicKeyHash)))
...
func NewPopulatedID(r randyProxy, easy bool) *ID {
	...
	v2 := r.Intn(100)
	this.PublicKeyHash = make([]byte, v2)
	for i := 0; i < v2; i++ {
		this.PublicKeyHash[i] = byte(r.Intn(256))
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
var fileDescriptorProxy = []byte{
	...
	0xaa, 0x95, 0x52, 0xb9, 0x98, 0x3c, 0x5d, 0x84, 0x64, 0xb9, 0xb8, 0x0a, 0x4a, 0x93, 0x72, 0x32,
	...
	,
}
