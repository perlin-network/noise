...
type ID struct {
	...
	// x are bytes that solve the dynamic S/Kademlia cryptopuzzle
...
func (m *ID) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.X) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintStream(dAtA, i, uint64(len(m.X)))
		i += copy(dAtA[i:], m.X)
	}
	return i, nil
}
...
var fileDescriptorStream = []byte{
	...
	,
}
